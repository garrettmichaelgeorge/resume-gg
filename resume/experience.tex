...
\begin{cventries}
	...
	{August 2024 -- Present} % Date(s)
	{
		\begin{cvitems}
			...
			Framework, DataDog)
			% \item Designed and developed event-driven serverless cloud solutions using
			% Node.js, Typescript, AWS (Lambda, API Gateway, DynamoDB, SQS),
			% Serverless Framework, and DataDog.
			...
			% \item Prioritized backlog items from a technical perspective
			% \item Own modernization and tech debt management across 80+ services.
			% \item Ensure my team delivers high-performing, supportable solutions which
			% promote reuse
			...
			% engineers.
			% \item Continuously refined and improve team processes to deliver high quality work consistently.
			% \item Managed production incident responses.
		\end{cvitems}
	}
